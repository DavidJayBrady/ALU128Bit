...
HD_PWD='C:/Users/David/MidtermProject3/MidtermProject3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU1B.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ALU1B.tcl -notrace
